...
summary: Signal your support or opposition to increase the Dust Parameter from 500 USDV to 2000 USDV for all vault-types.
...
The Governance Facilitators have placed a Governance Poll into the voting system on behalf of the Velero Governance Community. This Governance [Poll](https://community-development.makerdao.com/en/learn/governance/on-chain-gov) will be active for three days beginning on Monday, January 18 at 16:00 UTC.
...
* Increase the Dust Parameter from 500 USDV to 2000 USDV for all vault-types.
...
* If the Friday executive passes, then this change will become active in the Velero Protocol after the [GSM Pause Delay](https://community-development.makerdao.com/en/learn/governance/param-gsm-pause-delay) has expired.
...
To add current and upcoming votes to your calendar, please see the [VELERO Public Events Calendar](https://calendar.google.com/calendar/embed?src=makerdao.com_3efhm2ghipksegl009ktniomdk%40group.calendar.google.com&ctz=UTC&mode=week&showCalendars=0&showPrint=0).
